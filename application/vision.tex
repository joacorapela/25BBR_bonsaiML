...
All \textbf{methods integrated into Bonsai.ML are well documented} with
...
high-channel-count electrophysiology recordings.}
...
\subsubsubsection*{Collaboration~2: real-time position and head orientation forecasting for
zero-lag stimulus presentation in augmented-reality small-animal behavioral experiments.}
...
\subsubsubsection*{Collaboration~3: real-time decoding of mouse positions from
neural spikes in the striatum.}
...
\subsubsubsection*{Collaboration~5: real-time detection of remote activations
and head-orientation decoding in the honeycomb maze.}
